      ...
      <PopoverContent align="end">
        <div className="flex flex-col gap-5">
          <div className="space-y-1.5">
            ...
            <p className="text-muted-foreground text-xs">Atur tampilan dashboard sesuai kebutuhan.</p>
          </div>
          <div className="space-y-3 **:data-[slot=toggle-group]:w-full **:data-[slot=toggle-group-item]:flex-1 **:data-[slot=toggle-group-item]:text-xs">
            <div className="space-y-1">
              <Label className="font-medium text-xs">Preset Tema</Label>
            ...
            <div className="space-y-1">
              ...
              >
                ...
                <ToggleGroupItem value="system" aria-label="Pilih mode sistem">
                  Sistem
                </ToggleGroupItem>
              </ToggleGroup>
            </div>
            ...
            <div className="space-y-1">
              <Label className="font-medium text-xs">Layout Halaman</Label>
              <ToggleGroup
                size="sm"
                spacing={0}
                variant="outline"
              ...
              >
                <ToggleGroupItem value="centered" aria-label="Pilih rata tengah">
                  Tengah
                </ToggleGroupItem>
            ...
            <div className="space-y-1">
              <Label className="font-medium text-xs">Perilaku Navbar</Label>
              <ToggleGroup
                size="sm"
                spacing={0}
                variant="outline"
              ...
              >
                <ToggleGroupItem value="sticky" aria-label="Pilih navbar tetap">
                  Sticky
                </ToggleGroupItem>
                <ToggleGroupItem value="scroll" aria-label="Pilih navbar ikut scroll">
                  Scroll
                </ToggleGroupItem>
              </ToggleGroup>
            </div>
            ...
            <div className="space-y-1">
              <Label className="font-medium text-xs">Gaya Bilah Samping</Label>
              <ToggleGroup
                size="sm"
                spacing={0}
                variant="outline"
              ...
              >
                <ToggleGroupItem value="inset" aria-label="Pilih gaya inset">
                  Inset
                </ToggleGroupItem>
                <ToggleGroupItem value="sidebar" aria-label="Pilih gaya bilah samping">
                  Standar
                </ToggleGroupItem>
                <ToggleGroupItem value="floating" aria-label="Pilih gaya mengambang">
                  Mengambang
                </ToggleGroupItem>
              </ToggleGroup>
            </div>
            ...
            <div className="space-y-1">
              <Label className="font-medium text-xs">Mode Ciut Bilah Samping</Label>
              <ToggleGroup
                size="sm"
                spacing={0}
                variant="outline"
              ...
              >
                <ToggleGroupItem value="icon" aria-label="Pilih mode ikon">
                  Icon
                </ToggleGroupItem>
                <ToggleGroupItem value="offcanvas" aria-label="Pilih mode offcanvas">
                  OffCanvas
                </ToggleGroupItem>
              </ToggleGroup>
            </div>
